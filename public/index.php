        ...
        <section class="anonymity mt-4">
            <div class="grid grid-cols-2">
                <div class="col">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Sv7yxWOQVOg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col">
                    <img class="img_section" src="images/lock.png">
                </div>
            </div>
        </section>
